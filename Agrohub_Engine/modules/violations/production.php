<?php
/**
 * Violations Module - Production Manager Dashboard
 * For Production Managers - View all violations from all branches
 */
...
<head>
    ...
    <title>Production Manager - Violations</title>
...
<body>
    ...
    <main class="violations-main">
        ...
        <div class="page-header">
            <div class="page-title-section">
                <p class="page-subtitle">Production Management Dashboard</p>
                <h1 class="page-title">All Branches <span class="highlight">Overview</span></h1>
                <p class="page-description">
                    Monitor violations across all production facilities and branches.
                </p>
            </div>
    ...
    <script>
        ...
        async function exportReport() {
            if (!confirm('Export production report to CSV?')) {
                return;
            }
            
            try {
                let csv = 'ID,Title,Type,Status,Severity,Branch,Date,Description\n';
                
                allViolations.forEach(v => {
                    csv += `${v.id},"${v.title}","${v.type_name}","${v.status}","${v.severity}","${v.branch_name}","${v.violation_date}","${v.description}"\n`;
                });
                ...
                a.href = url;
                a.download = `production_violations_${new Date().toISOString().split('T')[0]}.csv`;
                a.click();
